...
import com.hexaware.quitq.service.IAddressService;
import com.hexaware.quitq.service.IUserService;

/*
 * @author Sownthrya S
 * @description Address ReST Controller which contains end-points to handle HTTP request and provide response
 * @date 9-08-2025
 * @version 1.0
 */
